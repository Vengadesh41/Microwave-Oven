...
unsigned char convection(unsigned char key, unsigned char reset_flag)
{
    ...
    if (set_temp_step == 1)
    {
        ...
        if (blink) clcd_print(Temp, (0xC0 + 6));
        else clcd_print("   ", (0xC0 + 6));
    }
    else
    {

        clcd_print("  Pre-Heating   ", (0x80 + 0));
        clcd_print(" Time Left: ", (0xC0 + 0));
...
unsigned char display_timer(unsigned char key, unsigned char reset_flag)
{
    ...
    if(reset_flag == 0x12)
    {
        ...
        clcd_print("4.START/RESUME", (0xC0 + 1));
        clcd_print("5.PAUSE", (0x90 + 1));
        clcd_print("6.STOP", (0xD0 + 1));
    ...
    clcd_print(Mins, (0x80 + 9));
    clcd_putch(':', (0x80 + 11));
    clcd_print(Secs, (0x80 + 12));
